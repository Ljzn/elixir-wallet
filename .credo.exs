  ...
  configs: [
    %{
      ...
      checks: [
        ...
        {Credo.Check.Consistency.ParameterPatternMatching, priority: :higher},
        {Credo.Check.Consistency.SpaceAroundOperators, priority: :higher},
        {Credo.Check.Consistency.SpaceInParentheses, priority: :higher},
        ...
        {Credo.Check.Readability.LargeNumbers, priority: :higher},
        ...
        {Credo.Check.Readability.RedundantBlankLines, priority: :high},
        ...
        {Credo.Check.Refactor.DoubleBooleanNegation, priority: :higher},
