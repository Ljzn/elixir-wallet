defmodule ChildKeyDerivation do
  ...
  test "bip32_vectors_1" do
    ...
    = master_key |> KeyPair.generate_master_key(:public) |> KeyPair.format_key()
    ...
    = master_key
    |> KeyPair.derive("m/0'") |> KeyPair.generate_master_key(:public) |> KeyPair.format_key()
    ...
    = master_key
    |> KeyPair.derive("m/0'/1") |> KeyPair.generate_master_key(:public) |> KeyPair.format_key()
    ...
    = master_key
    |> KeyPair.derive("m/0'/1/2'") |> KeyPair.generate_master_key(:public) |> KeyPair.format_key()
    ...
    = master_key
    |> KeyPair.derive("m/0'/1/2'/2") |> KeyPair.generate_master_key(:public) |> KeyPair.format_key()
    ...
    |> KeyPair.generate_master_key(:public) |> KeyPair.format_key()
